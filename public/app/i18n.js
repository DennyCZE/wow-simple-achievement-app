...
export const i18n = {
  cs: {
    ...
    summaryView: 'Souhrn',
    characterView: 'Postava',
    charLoading: 'Načítám profil postavy...',
    charLoadError: 'Profil postavy se nepodařilo načíst.',
    charLevel: 'Úroveň',
    charRace: 'Rasa',
    charClass: 'Třída',
    charSpec: 'Specializace',
    charFaction: 'Frakce',
    charGender: 'Pohlaví',
    charRealm: 'Realm',
    charGuild: 'Guilda',
    charItemLevel: 'Equipped iLvl',
    charAvgItemLevel: 'Průměrný iLvl',
    charLastLogin: 'Naposledy přihlášen',
    charNoGuild: '—',
  ...
  en: {
    ...
    charLoading: 'Loading character profile...',
    charLoadError: 'Failed to load character profile.',
    charLevel: 'Level',
    charRace: 'Race',
    charClass: 'Class',
    charSpec: 'Specialization',
    charFaction: 'Faction',
    charGender: 'Gender',
    charRealm: 'Realm',
    charGuild: 'Guild',
    charItemLevel: 'Equipped iLvl',
    charAvgItemLevel: 'Average iLvl',
    charLastLogin: 'Last login',
    charNoGuild: '—',
